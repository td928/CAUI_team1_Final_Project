...
def askforInput():
	...
	floorArea = raw_input("floorArea:")
	Occupancy = raw_input("Occupancy(0-100):")
	Units = raw_input("Number of Units:")
	Age = raw_input("Building Age: ")
	AvgEUI = raw_input("Estimated EUI in last 2-3 Years: ")
...
def getSimilarity(total_df, num_nb, features, input_list):
	...
	input_list_fixed = min_max_scaler.fit_transform(input_list)
